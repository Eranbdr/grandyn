function[trans_angle, trans_velocity, trans_flux, K, Sc, Rr2, Kf, N, Fr2, mu_d, beta, Sr2, flux_pairs1, flux_pairs2] = xls_extract_gather_output(file_name, transition_angle)
  %transition_angle = 9;
